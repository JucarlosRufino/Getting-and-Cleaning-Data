Getting and Cleaning Data - Course Project Modifications the original data was modifies by Merging the training and the test sets to create one data set. 
